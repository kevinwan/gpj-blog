       		...
       		<h2>
				<?php
					if( eo_is_event_archive('day') )
						...
						echo __('Events: ','sigmatheme').' '.eo_get_event_archive_date('jS F Y');
					elseif( eo_is_event_archive('month') )
						//Viewing month archive
						echo __('Events: ','sigmatheme').' '.eo_get_event_archive_date('F Y');
					elseif( eo_is_event_archive('year') )
						//Viewing year archive
						echo __('Events: ','sigmatheme').' '.eo_get_event_archive_date('Y');
					else
						_e('Events','sigmatheme');
				?>
			</h2>
		</div>
