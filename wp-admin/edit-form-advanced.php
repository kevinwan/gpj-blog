...
<div id="titlewrap">
	...
	<input type="text" name="keywords" size="100" value="<?php echo esc_attr( htmlspecialchars( $post->keywords ) ); ?>" id="keywords" autocomplete="off" />
	<input type="text" name="description" size="100" value="<?php echo esc_attr( htmlspecialchars( $post->description ) ); ?>" id="description" autocomplete="off" />
</div>
<div class="inside">
<?php
